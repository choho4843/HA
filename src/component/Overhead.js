                ...
                <div style={{ float: "right", width: "85%", height: "120" }}>
                    <div className="hl_main">
                        ...
                        <p className="hl_main2"  >
                            오버헤드 익스텐션은 라잉 트라이셉스 익스텐션과 함께 대표적인 <br />
                            상완삼두근의 중량운동입니다!<br />
                        ...
                        <p className="hl_player"  >
                            <ReactPlayer
                                className="player"
                                url={"https://www.youtube.com/watch?v=3Nqt05cRhpU"}
                                playing controls
                                width="1200px"
                                height="800px"
                            />
                        ...
                        <p className="hl_main3" >
                            덤벨을 뒤로 넘겨줄때 팔꿈치만 구부려주고 덤벨을 잡은 손목이 <br />
                            휘지 않도록 주의해주세요<br/>
                            팔꿈치를 구부려 덤벨을 몸의 뒤로 보내주는데 또한 움직임간 팔이 <br />
                            흔들리지 않고 고정된 상태로 행해야 한다는 것이<br />
                            덤벨 삼두운동의 가장 중요한 점입니다<br />
                           이렇게 삼두의 자극을 느끼며 돌아와서 반복합니다.<br/>
                            <br/>
