...
class Easybar extends Component {
    render() {
        return (
            <>
                ...
                <div style={{ float: "right", width: "85%", height: "120" }}>
                    <div className="hl_main">
                        ...
                        <p className="hl_main2"  >
                            이지바컬은 근력과 근육량을 모두 고려한다면 최고의 운동입니다!<br />
                            특히 이지바를 사용하게 되면 손목에 통증을 유발하지 않고 빠르게 근력을 키울수 있습니다.<br/>
                        </p>

                        <p className="hl_player"  >
                            <ReactPlayer
                                className="player"
                                url={"https://www.youtube.com/watch?v=Dlg0W_5mq98&t=385s"}
                                playing controls
                                width="1200px"
                                height="800px"
                            />
                        ...
                        이지바를 어깨 너비로 잡고 똑바로 선 후 손바닥은 바의 형태 때문에 약간 안쪽으로 기울어지는데 얼굴을 <br />
                        그다음 상완을 움직이지 않고 호흡을 밖으로 내쉬면서 컬동작으로 EZ-바를 들어올리면 됩니다. <br />
                            <br />

                        그 다음 호흡을 들이마시면서 천천히 바를 낮추어서 시작 위치로 복귀하면 됩니다.<br/>
