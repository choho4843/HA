                ...
                <div style={{ float: "right", width: "85%", height: "120" }}>
                    <div className="hl_main">
                        ...
                        <p className="hl_main2"  >
                            'P.T체조'로 잘 알려져있는 운동 동작으로,별다른 도구 없이 누구나 쉽게 도전할수 있는 
                            전신 유산소성 근력 운동 동작입니다!<br />
                            체지방 분해 효과는 물론 탄력 있는 몸을 만들 수 있는 최고의 운동 동작입니다.<br />
                        ...
                        <p className="hl_player"  >
                            <ReactPlayer
                                className="player"
                                url={"https://www.youtube.com/watch?v=zAm2uPAuxyE"}
                                playing controls
                                width="1200px"
                                height="800px"
                            />
                        ...
                        <p className="hl_main3" >
                            양팔을 붙인 채로 바르게 서있는 상태에서<br />
                            양팔을 머리 위로 올려 손뼉 치면서 제자리 점프하며 양다리를 
                            어깨너비로 벌려주세요<br />
                            <br />
                            <br />
                            다시 팔을 제자리로 위치시키면서 <br/>
                            제자리 점프하며 양발도 붙여 줍니다<br/>
                            (15회 1세트 X 3세트 반복)
