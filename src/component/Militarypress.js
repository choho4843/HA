                ...
                <div style={{ float: "right", width: "85%", height: "120" }}>
                    <div className="hl_main">
                        ...
                        <p className="hl_main2"  >
                            밀리터리 프레스(Military press), 혹은 오버헤드 프레스(Overhead Press)는 프레스 종류의 가장 기본적인 운동으로 삼각근 개발 외에도<br />
                            전신의 협응력을 키워주는 효과적인 운동이다. 어떤 인터넷 칼럼에서는 '서서하는 스쿼트'라고 말할 정도. 이 때문에 흔히 얘기하는 3대 운동에<br />
                            이 운동까지 포함하여 모든 사람들이 필수적으로 해야할 4대 운동이라고, 심지어는 코어 개입을 생각한다면 해당 운동이 벤치프레스 이상으로 중요한 운동이라고 주창하는 사람들도 많다.
                        </p>

                        <p className="hl_player"  >
                            <ReactPlayer
                                className="player"
                                url={"https://www.youtube.com/watch?v=lpc1P_zj3XI"}
                                playing controls
                                width="1200px"
                                height="800px"
                            />
                    ...
                    바벨을 스쿼트랙에 가슴 높이에 오도록 걸쳐 놓습니다.<br />
                    다리를 구부려 바를 어깨 쇄골 상단에 위치시키고, 그립은 어깨 너비보다 살짝 넓게 잡습니다. 팔꿈치는 어깨보다<br/>
                    앞으로 나가도록 그립을 잡아줍니다. 팔꿈치를 어깨와 일직선으로 잡게되면 전면 감각근의 자극이 덜 들어가게 됩니다.<br/>
                    바를 들고 나온 뒤, 어깨 너비 만큼 발을 벌리며 무게중심은 중간에 위치 해야합니다. 바벨을 완전히 들어 올렸을때 숨을 내 뱉고<br/>
                    바벨을 내릴때에는 상체를 살짝 뒤로 젖히면서 바벨을 무게중심 상에 오도록 해줍니다.

                            <br />
                            <br />
                        밀리터리 프레스는 하체의 균형이 중요하기 때문에 발바닥이 움직이거나 들려서는 안됩니다.<br/>
                        엉덩이를 뒤로 빼서 허리가 과도하게 아치를 만들거나, 허리가 뒤로 굽어지는 동작이 나오면 안됩니다.<br/>
                        바벨을 무게중심 수직선상에 그대로 위로 올려주어야합니다.<br/>
                        </p>
                    </div>
                </div>
            </>
