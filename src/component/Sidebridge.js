...
class Sidebridge extends Component {
    render() {
        return (
            <>
                ...
                <div style={{ float: "right", width: "85%", height: "120" }}>
                    <div className="hl_main">
                        ...
                        <p className="hl_main2"  >
                            사이드 브릿지는 우리 몸의 앞쪽과 뒤쪽의 핵심 근육들을 담당하는 운동!<br />
                            평소 앞뒤로 하는 움직임들이 익숙하기에 무게와 난이도만 조절한다면 큰 이질감 없이<br />
                            운동할수 있다
                        ...
                        <p className="hl_player"  >
                            <ReactPlayer
                                className="player"
                                url={"https://www.youtube.com/watch?v=Xpej0_byiqQ"}
                                playing controls
                                width="1200px"
                                height="800px"
                            />
                        ...
                        <p className="hl_main3" >
                            사이드브릿지는 옆으로 누워서 팔을 대고(어깨와 팔꿈치까지 일직선) 몸통을 둘어서
                            대각선으로 일직선 형태를 유지하는 운동이다<br />
                            <br />

                            이때 몸통의 옆부분(아래쪽)에 힘이 들어가면서 운동이 되는 방식이다.
