...
class Legextension extends Component {
    render() {
        return (
            <>
                ...
                레그익스텐션은 앉은 자리에서 무릎을 피는 동작을 하는 운동으로 대퇴사두근을 강화 할수 있는 운동입니다.<br/>
                보통은 헬스장에서 이 운동을 하기 위한 운동기구를 볼 수 있습니다. 헬스장에서 사용하는 레그 익스텐션 기구는 중량<br/>
                조절해서 운동을 할 수 있습니다.<br/>
                        </p>
                        ...
                        기구에 있는 의자에 앉은 후 의자를 알맞게 조절합니다. 그리고 다리를 올릴 때에 등이 의자에서<br/>
                        떨어지지 않게 합니다. 또한 발을 뻗을 때, 근육에 오는 자극을 느끼면서 발을 뻗으며 너무 빠르게 발을 뻗지 않습니다.<br/>

                            <br />
                            <br />
                            기구를 사용해서 운동을 할 경우에는 처음부터 무거운 무게를 들지 않습니다. 자신의 체력에 맞게 조금씩 조절해가며<br/>
                            운동합니다. 또한 무릎관절이 좋지 않은 경우에는 기구를 사용하는 중량운동은 전문가와 상담 후 하는 것이 좋습니다.<br/>
                            기구에서 하는 것이 아니라면 무릎에 큰 부담을 주지 않을 수 있지만, 기구에서 중량을 사용한다면 무릎관절에 부담을<br/>
                            줄 수 있습니다. 그리고 기구에서 중량을 사용하는 경우에 무릎을 굽혔다가 피는 과정에서 반동을 이용하지 않습니다.<br/>
                            반동을 이용하면 무릎에 큰 부담을 줄 수 있습니다. 그러므로 천천히 무릎을 펼 수 있는 중량을 이용하여 운동해야 합니다. <br/>
                        </p>
                    </div>
                </div>
            </>
