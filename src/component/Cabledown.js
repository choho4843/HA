...
class Cabledown extends Component {
    render() {
        return (
            <>
                ...
                <div style={{ float: "right", width: "85%", height: "120" }}>
                    <div className="hl_main">
                        ...
                        케이블 암플다운 운동은 케이블을 이용해서 하는 운동으로 광배근을 타겟으로 하는 운동입니다.<br/>
...
​
                        ...
                        <p className="hl_player"  >
                            <ReactPlayer
                                className="player"
                                url={"https://www.youtube.com/watch?v=bIo6_iFHE6U"}
                                playing controls
                                width="1200px"
                                height="800px"
                            />
                        ...
                        데드리프트와 비슷한 자세에서 팔을 위로 올렸다가 아래로 당기는 운동입니다.<br/>
                        이때,광배근이 사용되는데요. 어깨 관절하나만 활용해서 운동하기 때문에 초급자분들께서 쉽게 광배근<br/>
                        사용을 느낄수 있는 운동입니다.
                            <br />
                            <br />
                            견갑골을 밑으로 내리는데 주의하며, 허리와 등이 구부러지지 않게 가슴을 열어 척추 중립을 유지해야합니다.<br/>
                        </p>
                    </div>
                </div>
            </>
