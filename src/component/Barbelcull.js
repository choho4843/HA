...
class Babelcull extends Component {
    render() {
        return (
            <>
                    ...
                    <UncontrolledCollapse toggler="toggle5">
                        <CardBody>
                            ...
                            <Link to={'/cablepress'} id="logo" className="side_bar2"><b>&nbsp;&nbsp;케이블프레스다운</b></Link><br />
                ...
                <div style={{ float: "right", width: "85%", height: "120" }}>
                    <div className="hl_main">
                        ...
                        <p className="hl_main2"  >
                            이두근 운동의 기초이자 필수,베스트인 운동!<br/>
                            이두근을 골고루 단련할수있는 운동입니다!<br />
                        ...
                        <p className="hl_player"  >
                            <ReactPlayer
                                className="player"
                                url={"https://www.youtube.com/watch?v=FjT0VMmD238"}
                                playing controls
                                width="1200px"
                                height="800px"
                            />
                        ...
                        <p className="hl_main3" >
                            손 간격은 어깨 넓이로 맞춰주세요(비중을 더 두고 싶은 부위에 따라 손간격 조정)<br />
                            어깨 넓이보다 더 넓게 그립을 잡으면 이두근 안쪽이<br />
                            어깨 넓이보다 더 좁게 그립을 잡으면 이두근 바깥쪽이 더 자극됩니다.<br />
                            발 간격은 어깨 넓이로 단단하게 고정,팔꿈치도 옆구리에 고정시키고<br/>
                            몸을 조금 기울인채 왕복한다
