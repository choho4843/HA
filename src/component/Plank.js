                ...
                <div style={{ float: "right", width: "85%", height: "120" }}>
                    <div className="hl_main">
                        ...
                        <p className="hl_main2"  >
                            허리, 관절, 힘줄, 인대를 사용하지 않는 맨손 운동의 일종으로써 땅과 몸만 있으면 어디서나 가능한 운동이다.<br />
                            잠시동안 효과적인 코어/복근 운동으로 유행했고, 지금도 병원 유투브에서 올리는 허리디스크 재활 운동 안내에도<br />
                            거의 빠지지 않는 단골 수준이다<br/>
                        ...
                        <p className="hl_player"  >
                            <ReactPlayer
                                className="player"
                                url={"https://www.youtube.com/watch?v=v54Jtmi2BwU"}
                                playing controls
                                width="1200px"
                                height="800px"
                            />
                        ...
                        <p className="hl_main3" >
                            엎드린 자세에서 팔뚝으로 중심을 잡고 다리는 약간 벌린 상태로 일자를 유지한다.
                             몸은 전체에 걸쳐 일자상태를 유지한다.<br/>
                             팔꿈치와 어깨는 일자를 유지한다.<br/>
                            <br />

                            복부에 힘을 주고 몸을 앞으로 들어 올린다.수축을 몇 초간 유지한다.<br/>
                            턱은 약간 잡아당긴다. 운동을 실시하는 동안 복근을 계속 수축하게 한다.<br/>
                        </p>
                    </div>
                </div>
            </>
